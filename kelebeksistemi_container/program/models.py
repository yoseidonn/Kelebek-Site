...
class Purchase(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, verbose_name="Satın alımı yapan kullanıcı.")
...
class LicenseKey(models.Model):
    ...
    purchase = models.ForeignKey(Purchase, on_delete=models.DO_NOTHING, verbose_name="Satın alım:", null=True)
    key = models.CharField(verbose_name="Lisans anahtarı:", unique=True)
    key_type = models.CharField(choices=KEY_TYPE, verbose_name="Lisans tipi:", default="STD")
