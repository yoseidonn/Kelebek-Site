...
class Contact(models.Model):
    name = models.CharField(verbose_name="Ad", blank=True)
    email = models.EmailField(verbose_name="E-Posta", blank=True)
    title = models.CharField(verbose_name="Başlık", blank=True)
    text = models.CharField(verbose_name="Mesaj", blank=True)
